...
if (isset($_SESSION['id'])) {
    ...
    // Récupération données des annonces
    $annonces = $database->query("SELECT COUNT(id) FROM annonces")->fetchColumn();
    $annonces_pending = $database->query("SELECT COUNT(id) FROM annonces WHERE publish = 0")->fetchColumn();
} else {
...
<body>
            ...
            <nav class="navbar navbar-dark bg-dark pl-5 pr-5 pt-3 pb-3 nv_content" style="color: #f3f3f3;">
                ...
                <form class="form-inline login_post_buttons">
                    ...
                    <button id="admin"><i class="fas fa-sign-out-alt"></i> Quitter</button>
                </form>
            </nav>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <div class="content_menu_sidenav">
                <ul class="list-unstyled components">
                    ...
                    <li class="active">
                        <a href="#"><i class="fas fa-home" aria-hidden="true"></i> Tableau de bord</a>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenu">
                            <li>
                                <a href="/administration/site/"><i class="fas fa-sitemap" aria-hidden="true"></i> Site</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="usersSubmenu">
                            <li>
                                <a href="/administration/users"><i class="fas fa-eye" aria-hidden="true"></i> Voir tout</a>
                            </li>
                            <li>
                                <a href="/administration/users/banlist"><i class="fas fa-list" aria-hidden="true"></i> Liste des bans</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu">
                            <li>
                                <a href="/administration/announcements"><i class="fas fa-eye" aria-hidden="true"></i> Voir tout</a>
                            </li>
                            <li>
                                <a href="/administration/announcements/wait"><i class="fas fa-pause" aria-hidden="true"></i> En attentes</a>
                            </li>
                            <li>
                                <a href="/administration/announcements/valid"><i class="fas fa-check-circle" aria-hidden="true"></i> Acceptées</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="content">
            ...
            <div class="title_content mb-3">
                ...
                <span><i class="fas fa-home"></i> <a href="#">Tableau de bord</a></span>
            </div>
            ...
            <div class="content_dashboard">
                <div class="cards_dashboard mb-3">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4 cards_infos">
                            <div class="row">
                                <div class="col-12 col-sm-3 icon_card_col" style="background-color: #e67e22;">
                                    <div class="icon_card_dashboard">
                                        <i class="fas fa-3x fa-question" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-8 desc_card_col">
                                    <div class="desc_card_dashboard">
                                        <h5>En attentes</h5>
                                        <h2><?php echo $annonces_pending; ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4 cards_infos">
                            <div class="row">
                                <div class="col-12 col-sm-3 icon_card_col" style="background-color: #e74c3c;">
                                    <div class="icon_card_dashboard">
                                        <i class="fas fa-3x fa-bullhorn" aria-hidden="true"></i>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-8 desc_card_col">
                                    <div class="desc_card_dashboard">
                                        <h5>Annonces</h5>
                                        <h2><?php echo $annonces; ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 card_last_members_col mb-3">
                        <div class="card_last_members">
                            ...
                            <table class="table">
                                <tbody>
                                    <?php
                                        $query = $database->prepare("SELECT prenom, nom FROM users LIMIT 5");
                                        $query->execute();
                    ...
                    <div class="col-12 col-sm-6 card_last_members_col mb-3">
                        <div class="card_last_members" style="border-color: #e74c3c;">
                            ...
                            <table class="table">
                                <tbody>
                                    <?php
                                        $query = $database->prepare("SELECT * FROM annonces WHERE publish = 1 LIMIT 5");
                                        $query->execute();

                                        while ($row = $query->fetch()) {
                                            $phpdate = strtotime($row['date_publication']);
                                            $row['date_publication'] = date( 'd/m/Y', $phpdate );
                                    ?>
                                    <tr>
                                        <td><?php echo $row['date_publication']; ?></td>
                                        <td><?php echo $row['name']; ?></td>
                                        <td><span><?php echo $row['auteur']; ?></span></td>
                                        <td><button id="see"><i class="fas fa-eye" aria-hidden="true"></i> Voir</button></td>
                                        <td><button id="see" style="background-color: #f1c40f;"><i class="fas fa-pen" aria-hidden="true"></i> Editer</button></td>
                                        <td><button style="background-color: #e74c3c;" id="see" onclick="window.location.href='../account/'"><i class="fas fa-trash" aria-hidden="true"></i> Supprimer</button></td>
                                    </tr>
                                    <?php } ?>
